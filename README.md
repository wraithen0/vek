...
// Note: int8/uint8 dot products return 32-bit. For max-magnitude inputs
// (all 127 or all 255), the dot overflows the return type at ~133K int8
// or ~66K uint8 elements. Cosine remains correct for uint8 at any n. For
// int8 cosine, overflow in the dot accumulator affects the result above
// the same threshold. Embedding vectors (128–4096 dims) never approach
// these limits.
